...
public class OperatorHandler extends AbstractHandler implements IElementUpdater {
    
    private static final String PARM_INFO = "net.bioclipse.dropdown.radio.operator";
    private String fCurrentValue;
    
    public OperatorHandler() {
    	fCurrentValue="DEFAULT";
    }
